...
PROJECT_NAME=Agent-R1_Search-HotpotQA
...
OUTPUT_DIR=/data/Mamba/Project/Agent-R1/Search_HotpotQA/${MODEL_NAME}_${ADV_ESTIMATOR}_${RL_DATASET}_EPOCHS-${EPOCHS}_BS-${MICRO_BATCH_SIZE_PER_GPU}_KL-${KL_COEF}_ROLLOUT-${ROLLOUT}-MAXLEN-${MAX_RESPONSE_LENGTH}_${DATE_SUFFIX}

TRAIN_FILES=/data/Mamba/Project/Agent-R1/Search_HotpotQA/data/hotpotqa/train.parquet
VALID_FILES=/data/Mamba/Project/Agent-R1/Search_HotpotQA/data/hotpotqa/validation.parquet
